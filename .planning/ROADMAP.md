...
- [ ] 01-02: Entity types, Faker.js factories, and in-memory mock database
- [ ] 01-02b: API abstraction layer, MSW handlers, TanStack Query client, Zustand UI store, and providers
